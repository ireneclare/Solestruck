...
<table style="background-color: rgb(255, 255, 255); height:auto; padding-top:0px;" align="center" border="0" cellpadding="0" cellspacing="0" width="750">
  <tbody> 
    ...
    <tr>     
      <td>
      	<!-- <div class="photobook dn" id="nightrider_book_icon"> -->
      	<%-- <c:if test='${icon eq "book"}'> --%>
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" style="width:950px;height:450px" id="1f1fafdc-40e2-b7c4-a75f-773b5558c976" wmode="transparent"><param name="movie" value="http://static.issuu.com/webembed/viewers/style1/v2/IssuuReader.swf?mode=mini&amp;autoFlip=true&amp;shareMenuEnabled=false&amp;backgroundColor=%23222222&amp;documentId=111228211508-b3a0eebfe4de471a98f036ad15abec88" /><param name="allowfullscreen" value="true"/><param name="menu" value="false"/><param name="wmode" value="transparent"/><embed src="http://static.issuu.com/webembed/viewers/style1/v2/IssuuReader.swf" type="application/x-shockwave-flash" allowfullscreen="true" menu="false" wmode="transparent" style="width:950px;height:450px" flashvars="mode=mini&amp;autoFlip=true&amp;shareMenuEnabled=false&amp;backgroundColor=%23222222&amp;documentId=111228211508-b3a0eebfe4de471a98f036ad15abec88" wmode="transparent"/></object>
		 <!-- </div> -->	
		 <%-- </c:if> --%>
		 <%-- <c:if test="${icon eq 'video'}">
