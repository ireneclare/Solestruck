...
(function() {
	  var scriptLocation=('https:' == document.location.protocol ? 'https://ssl.' : 'http://www.') + location.host+'/script/${common_js}/${sr:styleScriptVersion(pageContext.request)}/getStatic.htm';
	  if(location.host.indexOf("www.solestruck.com")!=-1 || location.host.indexOf("solestruck.com")!=-1)
		  {
	 	 ...
	 	 else if(location.host.indexOf("localhost")!=-1 || location.host.indexOf("appspot.com")!=-1 || location.host.indexOf("a-cti.com")!=-1)
		  scriptLocation=('https:' == document.location.protocol ? 'https://' : 'http://') + location.host+'/script/${common_js}/${sr:styleScriptVersion(pageContext.request)}/getStatic.htm';
...
<div class="error_404_section">
	<div class="error_404">
      	<h4>we're so <br />embarrassed</h4>
        <h6>We couldn't find your page.</h6>
        <a href="/">Return to solestruck home page</a>
   </div>
</div>
