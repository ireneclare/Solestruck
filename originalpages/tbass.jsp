...
<link href="/style/${common_css}/getStatic.htm${sr:styleScriptVersion(pageContext.request)}" rel="stylesheet" type="text/css"/>
<script async type="text/javascript" src="/script/${common_js}/getStatic.htm${sr:styleScriptVersion(pageContext.request)}"></script>
...
<div class="menu_pathway">
         	<ul>
                ...
                <li class="path_arrow"></li>
                <li><span>To Be Announced SS/12</span></li>
        
            </ul>
            <div class="clear_both"></div>
</div><!-- menu_pathway -->

<h1>To Be Announced SS/12</h1>
...
<table style="background-color: rgb(255, 255, 255); height:auto; padding-top:0px;" align="center" border="0" cellpadding="0" cellspacing="0" width="750">
  <tbody> 
    ...
    <tr>     
      <td>
      	<div class="photobook">
			<div><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" style="width:950px;height:450px" id="9e63180e-672d-47ea-a938-64211888c63a" wmode="transparent" ><param name="movie" value="http://static.issuu.com/webembed/viewers/style1/v2/IssuuReader.swf?mode=mini&amp;autoFlip=true&amp;shareMenuEnabled=false&amp;backgroundColor=%23222222&amp;documentId=111121195413-989676fceba54e7891afbb9be572126f" /><param name="allowfullscreen" value="true"/><param name="menu" value="false"/><param name="wmode" value="transparent"/><embed src="http://static.issuu.com/webembed/viewers/style1/v2/IssuuReader.swf" type="application/x-shockwave-flash" allowfullscreen="true" menu="false" wmode="transparent" style="width:950px;height:450px" flashvars="mode=mini&amp;autoFlip=true&amp;shareMenuEnabled=false&amp;backgroundColor=%23222222&amp;documentId=111121195413-989676fceba54e7891afbb9be572126f" wmode="transparent" /></object></div>     
      </div>
      </td>
    </tr>
  </tbody>
