...
<!-- This jsp is created for FilteredProducts to display in CategoryPage By YES -->
		...
		<c:forEach items="${pageDTO.data}" var="newProMap">
				...
				<c:set var="w_space" value="shoe_holder"></c:set>
          		<c:if test="${(shoeCount%3)!=1 && (shoeCount%3)!=0}">
          	 	...
          	 	<div class="${w_space}" >
				<a  style="text-decoration: none;"  href="/${fn:replace(vendorNameSmall,' ','-')}-${fn:replace(productNameSmall,' ','-')}-${fn:replace(colorSmall,' ','-')}/index.html" style="text-decoration: none;" >
