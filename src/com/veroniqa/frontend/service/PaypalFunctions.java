...
public class PaypalFunctions  {
    ...
    public PaypalFunctions(boolean isSanbox) {//lhuynh - Actions to be Done on init of this class
    ...
    gv_APIUserName	= "shaik__1314798675_biz_api1.rediff.com";
    gv_APIPassword	= "1314798712";
    gv_APISignature = "ABllOu9A51OzKky-HzRjo2hCgtmfApteyeounX4xgm8anLd.h7AQ3gmP";

    boolean bSandbox = isSanbox;
