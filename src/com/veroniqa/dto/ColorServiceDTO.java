...
public class ColorServiceDTO implements Serializable{
	...
	public String getSystemColorId() {
		return systemColorId;
	}

	public void setSystemColorId(String systemColorId) {
